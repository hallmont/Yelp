...
class Business: NSObject {
    ...
    class func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: Int, offset: Int, completion: @escaping ([Business]?, Int?, Error?) -> Void) -> Void {
